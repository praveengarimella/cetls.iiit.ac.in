...
export const Route = createFileRoute("/advisory")({
  head: () => ({ meta: [{ title: "International Advisory Committee | CETLS" }] }),
  ...
  return (
    <SiteShell>
      <main className="mx-auto max-w-5xl px-5 py-14 sm:px-6 sm:py-16">
        <p className="text-sm font-medium tracking-wide text-accent uppercase mb-3">People</p>
        <h1 className="font-display text-4xl font-semibold tracking-tight mb-6">International Advisory Committee</h1>
        <p className="text-xl leading-relaxed text-muted max-w-3xl mb-16">
          The International Advisory Committee advises the Centre for Educational Technology and Learning Sciences (CETLS) at IIIT Hyderabad on research, design, and evidence at the meeting point of AI, educational technology, and the learning sciences. Members bring complementary strengths in cognitive systems and online learning, educational data mining, human-centered product research at scale, and the design of AI for learning and wellbeing — including work already grounded in Indian classrooms.
        </p>

        <div className="space-y-8">
          <article id="goel" className="bg-surface border border-border rounded-2xl p-6 sm:p-8">
            <div className="flex flex-col sm:flex-row gap-6 sm:gap-8">
              ...
              <div>
                <h2 className="font-display text-2xl font-semibold mb-1">Ashok K. Goel</h2>
          ...
          <article id="baker" className="bg-surface border border-border rounded-2xl p-6 sm:p-8">
            <div className="flex flex-col sm:flex-row gap-6 sm:gap-8">
              ...
              <div>
                <h2 className="font-display text-2xl font-semibold mb-1">Ryan S. Baker</h2>
          ...
          <article id="kam" className="bg-surface border border-border rounded-2xl p-6 sm:p-8">
            <div className="flex flex-col sm:flex-row gap-6 sm:gap-8">
              ...
              <div>
                <h2 className="font-display text-2xl font-semibold mb-1">Matthew Kam</h2>
          ...
          <article id="lomas" className="bg-surface border border-border rounded-2xl p-6 sm:p-8">
            <div className="flex flex-col sm:flex-row gap-6 sm:gap-8">
              ...
              <div>
                <h2 className="font-display text-2xl font-semibold mb-1">J. Derek Lomas</h2>
